...
export default function CreateTableModal({ onClose, onCreate, lang }: CreateTableModalProps) {
        ...
        <form onSubmit={handleSubmit} className="flex-1 overflow-y-auto p-4 space-y-4">
          ...
          <div>
            ...
            <div className="border border-[#2D2F34] rounded overflow-hidden bg-[#121418] divide-y divide-[#2D2F34]/50">
              {/* Table header row */}
              <div className="grid grid-cols-12 gap-2.5 p-2 bg-[#181A1F] text-[9.5px] font-bold uppercase tracking-widest text-gray-500 font-mono">
              ...
              <div className="divide-y divide-[#2D2F34]/30 max-h-56 overflow-y-auto">
                {columns.map((col, index) => (
                  <div key={index} className="grid grid-cols-12 gap-2.5 p-2 items-center hover:bg-[#1E2025]/40 font-mono text-xs">
                    ...
                    <div className="col-span-3">
                      <select
                        ...
                        className="w-full rounded border border-[#2D2F34] bg-[#0F1115] px-2 py-1 text-xs text-slate-300 outline-none focus:border-blue-500 cursor-pointer font-mono"
                      >
